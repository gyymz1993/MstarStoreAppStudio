...
public class ProductListActivity extends BaseActivity implements
        OnClickListener, CompoundButton.OnCheckedChangeListener, OnHeaderRefreshListener, OnFooterRefreshListener {
    ...
    private void initData() {
        ...
        showProductUrl = Constants2.SEARCH_URL + "&category=" + categoryId + "&keyword=" + URLtoUTF8Utils.toUtf8String(keyword) + "&key=" + key + "&order=" + order + "&curpage=" + curpage + "&page=" + showPageData;
