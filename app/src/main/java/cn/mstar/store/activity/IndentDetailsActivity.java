...
//			btn_pay_now.setBackgroundResource(R.drawable.notenabledgrey);
    ...
    private void cancelOrder(final String orderID) {
        ...
        view.findViewById(R.id.scan_history_confirm_btn).setOnClickListener(new OnClickListener() {
            @Override
            public void onClick(View v) {
                String cancelLink = NewLink.CANCEL_ORDER_LINK + "&orderNo=" + orderID + "&key=" + Utils.getTokenKey(app) + "&voucher_code=" + orderDetailsEntity.order.voucher_code;
...
//		http://localhost/workspace/shopnc/mobile/index.php?act=member_order&op=order_receive&orderNo=7000000000015901&key=ab3b185aaade2ce3b15f9def978a8ad0
        String link = NewLink.CONFIRM_RECEIVING_PRODUCT + "&orderNo=" + orderId + "&key=" + Utils.getTokenKey((MyApplication) getApplication());
...
//		Intent intent = null;
    ...
    private void pay_now() {
        ...
        String postUrl = "";
        postUrl = Constants2.POST_BUY_NOW_INDENT_URL + "&proId=" + proIds + "&proId_number=" + numbers +/*"&addressId="+receiverAddress.getAddressId()+*/
