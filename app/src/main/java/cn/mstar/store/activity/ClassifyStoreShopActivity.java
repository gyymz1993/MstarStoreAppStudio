    ...
    private void initListener() {
        ...
        /*classifylist.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                category = list.get(position).getGcId();
                changeURL();
...
//        classifylist.setAdapter(shopClassifyAdapter);
        showProductUrl = Constants2.BASE_URL + "act=shop_goods&op=index" + "&shopId=" + shopid + "&key=" + key + "&order=" + order + "&curpage=" + curpage + "&page=" + showPageData + "&category=" + category;
