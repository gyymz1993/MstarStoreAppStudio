...
import cn.mstar.store.customviews.TipsDialog;
import cn.mstar.store.customviews.TipsDialog.OnTipsDialogListener;
            ...
            VolleyRequest.GetCookieRequest(ManageReceiverAddressActivity.this, Constants2.GET_USER_ADDRESS_LIST + "&key=" + token,
                    new HttpStringRequsetCallBack() {
                        ...
                        public void onSuccess(String result) {
                            // TODO Auto-generated method stub
                            String str = Constants2.GET_USER_ADDRESS_LIST + "&key=" + token;
                            L.e(result);
                            if (result != null) {
                                try {
